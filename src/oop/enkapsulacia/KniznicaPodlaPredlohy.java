...
import oop.enkapsulacia.KnihaUdaje;

import java.io.*;
import java.util.ArrayList;
import java.util.Scanner;

public class KniznicaPodlaPredlohy {
        ArrayList<KnihaUdaje> zoznamKnih = new ArrayList<>(); // My sme vytvorili objekt, resp. ArrayList ako prazdny
        ...
        public void hladajKnihyPodlaNazvu() {
            ...
            ArrayList<KnihaUdaje> najdeneKnihy = new ArrayList<>(); // Prazdny zoznam najdenych knih
            for(KnihaUdaje konkretnaKniha: zoznamKnih) { // foreach pre prechadzanie kazdej knihy v nasom zozname knih
            ...
            for(KnihaUdaje najdenaKniha:najdeneKnihy) {
        ...
        public void pridajKnihu() {
            ...
            KnihaUdaje zadanaKniha = new KnihaUdaje(nazovKnihy, autor, rokVydania);
            ...
            while (!vybrataMenuPolozka.equals("koniec")) { // Nekonecny cyklus
                ...
                switch (vybrataMenuPolozka) { // "Prekonvertovali" sme String, cize text na male pismena
                    ...
                    case "3" -> {
                        ...
                        KnihaUdaje najdenaKniha = najdiKnihu();
...
/*                    if (odpoved.equalsIgnoreCase("a")) return; // Ukoncenie programu, resp. metody main bez navratovej hodnoty
        ...
        public ArrayList<KnihaUdaje> naplnKniznicuKnihami() {

            // Vytvorime prvu ukazkovu knihu, teda objekt kniha1
            KnihaUdaje kniha1 = new KnihaUdaje("Já, robot", "Isaac Asimov", 1919);
            KnihaUdaje kniha2 = new KnihaUdaje("1984", "George Orwell", 1915);
            KnihaUdaje kniha3 = new KnihaUdaje("To Kill a Mockingbird", "Harper Lee", 1982);
            KnihaUdaje kniha4 = new KnihaUdaje("Mali princ", "Antoine de Saint-Exupéry", 2000);
            KnihaUdaje kniha5 = new KnihaUdaje("Vládca prsteňov", "J.R.R. Tolkien", 1925);

            // Vytvorenie dynamickeho pola, teda ArrayList-u v ktorom ulozime knihy
            ArrayList<KnihaUdaje> zoznamKnih = new ArrayList<>();
